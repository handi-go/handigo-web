      ...
      <div className="display flex">
        ...
        <div className="bg-[#f5f5f5] w-full">
          <div className="mt-5 ml-5">
            <div className="display flex">
              <div className="display flex w-11/12 items-center justify-between mr-52">
            ...
            <div className="display flex items-center justify-between w-10/12">
            ...
            <div className="display flex gap-5 mt-6">
              <div className=" bg-white w-52 px-3 py-3 rounded-md">
            ...
            <div className="display flex justify-between w-10/12 mt-8 pl-5">
            ...
            <div className="w-10/12 h-16 display flex justify-between bg-white rounded-md mt-6 ">
            ...
            <div className="w-10/12 h-16 display flex justify-between bg-white rounded-md mt-3 ">
              <div className="display flex items-center gap-3 pl-5">
                <img
                  className="w-9 h-9 rounded-full"
                  src="src\assets\Images\Picture 1.jpg"
