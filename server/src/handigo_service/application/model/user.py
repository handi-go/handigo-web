...
class User(BaseSqlModel, table=True):  # type: ignore[call-arg]
    ...
    profile_photo: str | None = Field(default=None, nullable=True)
    date_of_birth: str | None = Field(default=None, nullable=True)
    street_address: str | None = Field(default=None, nullable=True)
    postal_code: str | None = Field(default=None, nullable=True)
    ...
    profession: str | None = Field(default=None, nullable=True)
    hashed_password: str = Field(nullable=False)
    bank_name: str | None = Field(default=None, nullable=True)
    bank_account_number: str | None = Field(default=None, nullable=True)
    bank_account_name: str | None = Field(default=None, nullable=True)
